                      ...
                      <form className="w-full" onSubmit={handleSubmit}>
                        <div className="mb-4 lg:mt-8 md:mt-8 mt-5">
                          <div className="fonts-sans font-inter">
                            ...
                            <input type="text" id="Email Address" placeholder="Enter Email Address" value={username} onChange={handleUsernameChange} name="Email Address" className="w-full border-b bg-white border-gray-300 text-sm lg:text-lg md:text-md focus:outline-none focus:border-gray-300" required />
                          </div>
                        </div>
                        <div className="mb-4 md:mt-8 lg:mt-8 mt-0">
                          <div className="fonts-sans font-inter">
                            ...
                            <input type="password" id="password" placeholder="Enter Password" value={password} onChange={handlePasswordChange} name="password" className="w-full border-b bg-white border-gray-300 text-sm lg:text-lg md:text-md focus:outline-none focus:border-gray-300" required />
                          </div>
                        </div>
