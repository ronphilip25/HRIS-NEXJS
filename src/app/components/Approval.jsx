...
const Approval = () => {
    return (
        <>
            <div className="rounded-xl bg-white p-2 shadow-md col-span-2 lg:col-span-2 lg:col-start-2 lg:row-start-3 md:col-span-1 md:row-start-4">
                <div className="relative">
                    <div className="absolute right-0 top-0"></div>
                    <div className="ml-2 font-sans">
                        <h5 className="lg:text-2xl font-bold text-gray-600 md:text-base">Needs Approval</h5>
                    </div>
                </div>
                <div className="grid grid-cols-5 gap-3 font-sans font-inter text-base font-bold text-gray-700 mt-2 ml-2 py-1 md:text-xs md:mt-5">
