...
const CompanyNews = () => {
    return (
        <>
            ...
            <div className="rounded-xl bg-white lg:p-4 md:p-2 shadow-md col-span-1 lg:col-start-4 lg:h-auto lg:row-start-3 md:row-start-4 overflow-x-auto overflow-y-auto h-[24vh] md:h-[35vh]">
