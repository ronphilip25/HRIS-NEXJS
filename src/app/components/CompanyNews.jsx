...
const CompanyNews = () => {
    return (
        <>
            <div className='rounded-lg bg-white lg:p-4 p-2 pt-3 shadow-md lg:row-span-2 md:row-span-1 overflow-x-auto overflow-y-auto lg:max-[1440px]:w-4/5 lg:max-[1440px]:h-auto lg:h-full md:h-[16vh] h-[35vh]'>
                <div className="">
