    ...
    return (
        <>
            <div className="rounded-xl bg-white p-2 shadow-md col-span-1">
                ...
                <div className="grid grid-cols-4 font-sans font-inter text-xs font-bold text-gray-700 mt-3 ml-2 py-2 overflow-x-auto overflow-visible lg:h-[35vh] md:h-[23vh] h-[35vh]">
                    <table className="col-span-4 border-separate border-spacing-y-[1rem] my-[-2rem]">
                        <thead>
                            <tr>
                        ...
                        <tbody className="font-sans text-xs font-normal font-inter">
                            ...
                            <tr>
                                ...
                                <td className="px-4 text-center">dasdas</td>
                                <td className="px-4 text-center">dada</td>
                                <td className="px-4 text-center">saddas</td>
                            </tr>
                            <tr>
                                <td className="px-0 py-2 text-center">addas</td>
                                <td className="px-4 text-center">dasdas</td>
