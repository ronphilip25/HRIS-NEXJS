...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <>
      <div className={`flex flex-col lg:h-screen md:h-auto lg:max-[1024px]:h-screen sticky bg-white text-black border ${isOpen ? 'lg:w-[286px] md:w-[250px] w-[200px] lg:block md:block hidden' : 'lg:w-44 md:w-34 w-36 lg:block md:block hidden'}  transition-all duration-500 shadow-lg`}>
