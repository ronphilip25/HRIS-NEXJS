    ...
    return (
        <>
            <div className='lg:col-start-1 lg:col-span-3 md:col-span-2 lg:max-[1024px]:col-span-2'>
                <div className="rounded-lg bg-white p-2 lg:max-[1440px]:h-auto lg:max-[1024px]:h-auto lg:h-auto md:h-[74vh] w-auto shadow-md">
                    ...
                    <div className="lg:grid lg:grid-cols-8 grid grid-cols-8 font-sans text-base font-bold text-gray-700 lg:ml-1 lg:py-2 lg:p-4">
                        ...
                        <div className="col-span-8 overflow-x-auto h-[32vh] lg:max-[1440px]:h-[30vh] lg:h-[22vh] md:max-[768px]:h-[5vh] lg:max-[1024px]:h-[24vh] md:h-[10vh]">
                            <table className="w-full table-fixed">
