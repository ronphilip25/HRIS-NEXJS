...
const AttendanceWidget = () => {
    return (
        <>
            <div className="rounded-lg shadow-md bg-white w-full h-[119px] p-2">
                <h2 className="text-md ml-2 mt-2 font-normal">Period</h2>
                <div className="font-inter font-sans">
                    <div className="rounded-lg border border-gray-600 relative w-full mt-4">
                        <div
                            className="font-sans font-inter text-base font-bold text-gray-700 py-[7px] flex justify-center mr-4"
                        >
                            <div className="mr-4">
                                <svg
                                    width="24"
            ...
            <div className="rounded-lg shadow-md bg-white w-full h-[119px] p-2">
                ...
                <div className="relative inline-block w-full mt-4">
                    <button type="button" className=" flex item-start justify-between py-[7px] w-full rounded-md bg-white text-base font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-700" id="menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <div id="dropdown-menu" className="absolute z-10 right-0 mt-2 w-full bg-white rounded-md shadow-lg hidden">
                        <ul className="py-1">
