...
export default function Navbar({ isOpen, toggleSidebar }) {
  ...
  return (
    <>
      <nav className={`${isOpen ? 'w-[1657px]' : 'w-full'} sticky w-auto lg:max-[1440px]:max-w-auto transition-width duration-500 ease-in-out lg:relative md:relative flex lg:h-20 md:h-16 lg:max-[1024px]:h-16 h-20 items-center justify-center bg-white border rounded-sm border-gray-200`}>
        <div>
