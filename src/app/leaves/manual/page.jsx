...
const page = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 lg:h-auto md:max-w-auto md:overflow-x-auto md:h-screen overflow-x-scroll h-screen pb-2 ">
          <div className="flex flex-col">
            <div className="flex items-center justify-end">
              <button className="h-[47px] w-[156px] rounded-lg bg-blue-600 text-base font-bold text-white shadow-lg">
                Adjust in Bulk
              </button>
            </div>
            <div className="mt-5">
              <div className="h-[228px] rounded-lg bg-white shadow-lg">
                <div className="mt-3 flex items-center justify-between p-5">
                  <button
                    id="dropdownBtn"
                    type="button"
                    className="ml-2 inline-flex h-[34px] w-[264px] justify-between rounded-md border border-gray-300 bg-white p-2 px-4 text-sm font-medium text-gray-700 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
                    2024
                  ...
                  <div className="relative mr-2">
                    <input
                      type="text"
                      placeholder="Search"
                      className="h-[34px] w-[264px] rounded-md border border-gray-300 bg-white px-4 py-2 outline-none focus:border-blue-500"
                    />
                ...
                <div className="p-2 mr-4 ml-4">
                  <table className="w-full">
                    <thead>
                      <tr className="">
                        <th className="text-center text-sm font-sans font-bold border-b border-gray-500 text-gray-500 ">
                          Name
                        </th>
                        <th className="text-center text-sm font-sans font-bold border-b border-gray-500 text-gray-500 ">
                          Status
                        ...
                        <th className="text-center text-sm font-sans font-bold text-gray-500 border-b border-gray-500 ">
                          Days Current
                        </th>
