            ...
            <div className='lg:grid lg:grid-cols-4 lg:gap-4 md:grid md:grid-cols-2 md:gap-2 gap-4 md:flex-shrink-0 flex flex-col mx-4 lg:mx-auto'>
                <div className="flex items-center justify-center">
                    <div className="rounded-lg border border-gray-400 animate-pulse lg:px-auto lg:h-[119px] lg:p-4 shadow-md md:w-full md:h-[119px] md:flex-shrink-0 md:px-auto md:p-4 px-1 h-[90px] w-full">
                        ...
                        <h2 className="animate-pulse h-4 w-16 rounded bg-gray-400 ml-2 mt-2 "></h2>
                        <div className="font-inter ml-2 font-sans">
                            <h3 className="rounded h-4 w-12 animate-pulse mt-4 bg-gray-400 font-sans text-4xl"></h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-xl border animate-pulse border-gray-400 p-2 shadow-md col-span-2 lg:col-span-2 lg:col-start-2 lg:row-start-3 md:col-span-1 md:py-4 md:row-start-4 ">
                    <div className="relative">
                        ...
                        <div className="ml-2 font-sans">
                            <h5 className="bg-gradient-to-r from-gray-200 via-gray-400 rounded h-8 w-[200px]"></h5>
                        </div>
                    </div>
                    <div className="grid grid-cols-5 gap-3 font-sans font-inter font-bold text-gray-700  ml-2 py-1 md:text-xs md:mt-5 text-xs   ">
