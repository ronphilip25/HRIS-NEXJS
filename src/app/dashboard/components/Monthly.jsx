...
const Monthly = () => {
    ...
    return (
        <>
            <div className="rounded-xl bg-white p-2 shadow-md col-span-1 lg:h-auto md:max-w-auto md:h-auto lg:max-[1440px]:h-auto h-auto md:row-start-4 lg:row-start-2 lg:col-start-3">
