      ...
      <div>
        ...
        <div className="flex bg-blue-50 bg-opacity-100 z-50">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <main className={` ${isOpen ? 'lg:mx-12 lg:max-[1440px]:mx-7 md:max-mx-auto' : 'lg:mr-[95px] md:mr-[95px]  md:ml-5 md:max-[916px]:ml-auto'} overflow-hidden  mx-auto mt-3 lg:max-[1024px]:mt-2 container w-auto transition-all duration-700`}>
              {children}
            </main>
          </div>
        </div>
