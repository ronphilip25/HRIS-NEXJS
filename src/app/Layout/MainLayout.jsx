      ...
      <div>
        ...
        <div className="flex h-screen bg-blue-50 bg-opacity-100 z-50">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <main className={` ${isOpen ? 'lg:mx-8' : 'lg:mr-[14px] mx-auto md:mx-auto lg:mx-0'} mt-3 container h-full overflow-x-auto lg:w-auto md:w-auto w-full mx-auto transition-all duration-500`}>
              {children}
            </main>
          </div>
        </div>
